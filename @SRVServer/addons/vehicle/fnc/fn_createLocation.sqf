{
	...
	private _listPosition	= _x select 5;
	private _isPernament 	= _x select 6;
	...
	{
		private _newPosition = [selectRandom _positions, 0, SRVVehicle_cfg_LocationRadius, 5, 0 , 1 , 0] call BIS_fnc_findSafePos;
