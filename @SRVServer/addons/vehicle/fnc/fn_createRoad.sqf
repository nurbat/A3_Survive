{
	...
	{
		private _tmpPosition = [SRVVehicle_cfg_RandomCenter, SRVVehicle_cfg_RandomRadius] call SRVCore_fnc_findRoadPosition;
		private _newPosition = [_tmpPosition, 25, SRVVehicle_cfg_RoadRadius, 5, 0 , 1 , 0] call BIS_fnc_findSafePos;
